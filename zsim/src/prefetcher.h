...
class AnlPrefetcher : public StreamPrefetcher {
    private:
        AnlArray<16> mtable;
        g_unordered_map<uint64_t, uint64_t> pfBuffer;

    public:
        explicit AnlPrefetcher(const g_string& _name) : StreamPrefetcher(_name) {}
